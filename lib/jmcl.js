...
var LegacyMCArg = (function () {
    function LegacyMCArg(argTemp) {
        this.argTemp = argTemp;
        this.argv = {};
    }
    LegacyMCArg.prototype.arg = function (name, v) {
        this.argv[name] = v;
        return this;
    };
    LegacyMCArg.prototype.gameArg = function () {
    ...
    LegacyMCArg.prototype.jvmArg = function () {
        return [
            "-Xincgc",
...
var NewMCArg = (function () {
    function NewMCArg(_argJson) {
        this._argJson = _argJson;
        this.argv = {};
    }
    NewMCArg.prototype._checkRule = function (rule) {
        if (rule.os) {
            var _a = getOS(), osName = _a.osName, osV = _a.osV, osArch = _a.osArch;
    ...
    NewMCArg.prototype._checkRules = function (rules) {
    ...
    NewMCArg.prototype._replaceVals = function (ret) {
        for (var name in this.argv) {
            ret = ret.replace('${' + name + '}', this.argv[name]);
        }
        return ret;
    };
    NewMCArg.prototype._genArg = function (argItem) {
        var ret = [];
        for (var _i = 0, argItem_1 = argItem; _i < argItem_1.length; _i++) {
            var arg = argItem_1[_i];
            if (arg.compatibilityRules === undefined || this._checkRules(arg.compatibilityRules)) {
                for (var _a = 0, _b = arg.value; _a < _b.length; _a++) {
                    var val = _b[_a];
    ...
    NewMCArg.prototype.arg = function (name, v) {
        this.argv[name] = v;
        return this;
    };
    NewMCArg.prototype.gameArg = function () {
        return this._genArg(this._argJson.game);
    };
    NewMCArg.prototype.jvmArg = function () {
...
var UserManager = (function () {
    ...
    UserManager.prototype.offlineUser = function (uname) {
...
var OfflineUser = (function (_super) {
    __extends(OfflineUser, _super);
    function OfflineUser(name) {
        var _this = _super.call(this) || this;
        _this.name = name;
        return _this;
    }
    OfflineUser.prototype.getType = function () { return 'legacy'; };
    OfflineUser.prototype.getName = function () { return this.name; };
    OfflineUser.prototype.getUUID = function () { return '{}'; };
    OfflineUser.prototype.getToken = function () { return '{}'; };
    return OfflineUser;
}(User));
...
var Context = (function () {
    function Context(console, logLevel) {
